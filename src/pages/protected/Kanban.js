...
function App() {
    ...
    const handleEditTask = (boardId, taskId, newName) => {
        const boardIndex = boards.findIndex((board) => board._id === boardId);
                                                    ...
                                                    >
                                                        <div className="flex">
                                                            <div className="flex-2">
                                                                <div className="badge badge-primary badge-outline mr-2 ">Bug</div>
                                                                <div className="badge badge-secondary badge-outline ">Urgent</div>
                                                            </div>
